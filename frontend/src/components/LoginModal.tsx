    ...
    return (
        <Dialog open={show} onClose={onClose} className="relative z-50">
            ...
            <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
                <DialogPanel className="bg-[#232323] rounded-lg shadow-xl w-full max-w-sm p-6 relative">
                    <button
                    ...
                    <DialogTitle className="text-xl font-semibold mb-4 text-white">Sign In</DialogTitle>
